...
(
   id number NOT NULL ,
   java_class_name varchar2(255) NOT NULL,
   java_class_name_short varchar2(32) NOT NULL,
   java_class_name_crc number NOT NULL,
...
(
   date_value number NOT NULL,
   full_year number NOT NULL,
   half_of_year number NOT NULL,
   quarter_of_year number NOT NULL,
   month_of_year number NOT NULL,
...
CREATE SEQUENCE alf_prop_date_value_seq START WITH 1 INCREMENT BY 1;

CREATE TABLE alf_prop_double_value
(
   id number NOT NULL ,
   double_value number NOT NULL,
...
(
   ...
   string_end_lower varchar2(16) NOT NULL,
   string_crc number NOT NULL, 
...
(
   id number NOT NULL ,
   actual_type_id number NOT NULL,
   persisted_type number NOT NULL,
   long_value number NOT NULL,   
...
(
   root_prop_id number NOT NULL,
   prop_index number NOT NULL,
   contained_in number NOT NULL,
   key_prop_id number NOT NULL,
   value_prop_id number NOT NULL,  
...
CREATE SEQUENCE alf_prop_link_seq START WITH 1 INCREMENT BY 1;

CREATE TABLE alf_prop_unique_ctx
(
   id number NOT NULL ,
   version number NOT NULL,
   value1_prop_id number NOT NULL,
   value2_prop_id number NOT NULL,
   value3_prop_id number NOT NULL,
   prop1_id number,
